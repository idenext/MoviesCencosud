...
class BaseViewController: UIViewController {
    ...
    func configNavigationBar(){
        ...
        let share = buildButtons(selector: #selector(shareButtonPressed), image: (UIImage(named: "cast")?.withRenderingMode(.alwaysTemplate))!, inset: 30)
        let magnify = buildButtons(selector: #selector(magnifyButtonPressed), image: (UIImage(named: "magnifying")?.withRenderingMode(.alwaysTemplate))!, inset: 33)
        let dots = buildButtons(selector: #selector(dotsButtonPressed), image: (UIImage(named: "dots")?.withRenderingMode(.alwaysTemplate))!, inset: 33)
